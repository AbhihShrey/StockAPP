...
const CHART_STYLE_KEY = 'vertex_chart_style'
const QUIET_HOURS_KEY = 'vertex_quiet_hours'
const LANDING_KEY = 'vertex_default_landing'
...
export function saveDefaultLanding(path) {
  ...
  window.dispatchEvent(new CustomEvent('vertex-prefs-changed', { detail: { key: 'landing', value: path } }))
}
...
export function saveLocale(l) {
  ...
  window.dispatchEvent(new CustomEvent('vertex-prefs-changed', { detail: { key: 'locale', value: l } }))
}
...
export function saveChartStyle(s) {
  ...
  window.dispatchEvent(new CustomEvent('vertex-prefs-changed', { detail: { key: 'chartStyle', value: s } }))
}
