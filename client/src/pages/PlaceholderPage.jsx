      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-zinc-500 sm:text-base">
            Ember Finances gives you the tools to read the market, track positions, and stress-test ideas — without switching between a dozen tabs.
          </p>
        </div>
    ...
    <PageShell>
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-zinc-500 sm:text-base">
            Whether you trade intraday or hold for years, Ember Finances surfaces the signals you care about and hides the noise you don't.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-3">
          {[
            ...
            { icon: Briefcase, label: 'No brokerage required', desc: 'Ember Finances is a research and planning tool. There is nothing to link — sign up and start immediately.' },
          ].map((c) => {
            const Icon = c.icon
            return (
