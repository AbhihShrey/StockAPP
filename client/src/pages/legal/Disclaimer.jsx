...
export function Disclaimer() {
  return (
    <LegalShell title="Financial Disclaimer" lastUpdated="April 26, 2026">
      <div className="rounded-[14px] border border-warn/25 bg-warn/10 p-5 text-sm leading-relaxed text-warn">
        <p className="font-semibold text-warn">Ember Finance is for informational purposes only.</p>
      ...
      <p>
        All content on Ember Finance — including watchlists, scanners, backtests, sector rotation views,
      ...
      <p>
        ...
        labeled where possible but never guaranteed. Ember Finance makes no warranty as to accuracy,
        completeness, or timeliness of any data displayed.
      </p>

      <h2>3. Past performance is not indicative of future results</h2>
      <p>
        Backtests and historical metrics shown on Ember Finance represent hypothetical, past behavior of a
      ...
      <p>
        Use of Ember Finance does not create a fiduciary, advisor-client, broker-client, or other professional
        relationship between you and Ember Finance or its operators. We owe you no duty of care with respect
      ...
      <p>
        Ember Finance may link to third-party websites or data providers. We are not responsible for the
        content, accuracy, or practices of those third parties.
      </p>

      <h2>8. Acknowledgement</h2>
      <p>
        By using Ember Finance, you acknowledge that you have read and understood this Disclaimer and agree
