  ...
  return (
    <LegalShell title="Financial Disclaimer" lastUpdated="April 26, 2026">
      <div className="rounded-xl border border-amber-500/25 bg-amber-500/[0.06] p-5 text-sm leading-relaxed text-amber-100">
        <p className="font-semibold text-amber-200">Vertex is for informational purposes only.</p>
      ...
      <p>
        All content on Vertex — including watchlists, scanners, backtests, sector rotation views,
      ...
      <p>
        ...
        labeled where possible but never guaranteed. Vertex makes no warranty as to accuracy,
        completeness, or timeliness of any data displayed.
      </p>

      <h2>3. Past performance is not indicative of future results</h2>
      <p>
        Backtests and historical metrics shown on Vertex represent hypothetical, past behavior of a
      ...
      <p>
        Use of Vertex does not create a fiduciary, advisor-client, broker-client, or other professional
        relationship between you and Vertex or its operators. We owe you no duty of care with respect
      ...
      <p>
        Vertex may link to third-party websites or data providers. We are not responsible for the
        content, accuracy, or practices of those third parties.
      </p>

      <h2>8. Acknowledgement</h2>
      <p>
        By using Vertex, you acknowledge that you have read and understood this Disclaimer and agree
