  ...
  return (
    <LegalShell title="Cookie Policy" lastUpdated="April 26, 2026">
      ...
      <ul>
        ...
        <li><strong>Alert sound preference</strong> (<code>ember_alert_sound</code>) — whether the in-browser alert chime is muted.</li>
      ...
      <h2>6. Contact</h2>
      <p>Questions? Email <a href="mailto:support@emberfinances.com">support@emberfinances.com</a>.</p>
