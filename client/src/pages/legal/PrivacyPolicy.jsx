...
export function PrivacyPolicy() {
  return (
    <LegalShell title="Privacy Policy" lastUpdated="April 26, 2026">
      <p>
        This Privacy Policy explains what information Ember Finance (&ldquo;we&rdquo;, &ldquo;us&rdquo;) collects,
        how we use it, and the choices you have. By creating an account or using Ember Finance you agree to the
      ...
      <ul>
        <li><strong>Financial Modeling Prep (FMP)</strong> — provides the market data shown on Ember Finance. Symbols you look up may appear in their request logs. See <a href="https://financialmodelingprep.com" target="_blank" rel="noopener noreferrer">financialmodelingprep.com</a>.</li>
        ...
        <li><strong>Hosting provider</strong> — runs the Ember Finance application servers and stores the database.</li>
      </ul>

      <h2>4. Cookies and local storage</h2>
      <p>
        Ember Finance does not use third-party advertising or analytics cookies. We use your browser&rsquo;s
      ...
      <h2>8. Children</h2>
      <p>
        Ember Finance is not directed at children under 13 (or under 16 in the EEA). We do not knowingly collect
