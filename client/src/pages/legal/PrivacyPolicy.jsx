...
export function PrivacyPolicy() {
  return (
    <LegalShell title="Privacy Policy" lastUpdated="April 26, 2026">
      <p>
        This Privacy Policy explains what information Vertex (&ldquo;we&rdquo;, &ldquo;us&rdquo;) collects,
        how we use it, and the choices you have. By creating an account or using Vertex you agree to the
      ...
      <ul>
        <li><strong>Financial Modeling Prep (FMP)</strong> — provides the market data shown on Vertex. Symbols you look up may appear in their request logs. See <a href="https://financialmodelingprep.com" target="_blank" rel="noopener noreferrer">financialmodelingprep.com</a>.</li>
        ...
        <li><strong>Hosting provider</strong> — runs the Vertex application servers and stores the database.</li>
      </ul>

      <h2>4. Cookies and local storage</h2>
      <p>
        Vertex does not use third-party advertising or analytics cookies. We use your browser&rsquo;s
      ...
      <h2>8. Children</h2>
      <p>
        Vertex is not directed at children under 13 (or under 16 in the EEA). We do not knowingly collect
      ...
      <p className="mt-10 rounded-xl border border-white/10 bg-white/[0.03] p-4 text-xs text-zinc-500">
        <strong className="text-zinc-300">Template notice.</strong> This document is a starting-point template
        and is not legal advice. Replace the bracketed placeholders ([contact email], etc.) and have a
        qualified attorney review it before relying on it for compliance purposes.
      </p>
    </LegalShell>
  )
}
